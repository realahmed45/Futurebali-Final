...
const Package3 = () => {
  ...
  const handleProceed = () => {
    ...
    navigate("/package3-cart", { state: { selectedAddOns } });
  };
    ...
    <div className="packages1-container">
        ...
        <div className="features-left">
          ...
          <div className="feature-item">
            <div className="feature-title">
              <span className="yellow-text">
                {" "}
                <span className="highlight-yellow">• </span> 1 room 19-22m²
              </span>
            </div>

            <div className="feature-detail">
              • Walk in closet toward bathroom*
            </div>
          </div>
          ...
          <div className="feature-item">
            <div className="feature-title">
              <span className="yellow-text">
                {" "}
                <span className="highlight-yellow">• </span> 1 kitchen 11-14 m²
              </span>
            </div>
          </div>
          ...
          <div className="feature-item">
            <div className="feature-title">
              <span className="yellow-text">
                {" "}
                <span className="highlight-yellow">• </span> 1 bathroom 8-14m²
              </span>
            </div>
            <div className="feature-detail">
              <ul>
          ...
          <div className="feature-item">
            <div className="feature-title">
              <span className="yellow-text">
                {" "}
                <span className="highlight-yellow">• </span> All furnishing is
                included
              </span>
            </div>
            <div className="feature-detail">
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="checkbox"
                        onChange={() =>
                          handleCheckboxChange("Bedroom", "38 m²", 2000)
                        }
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input
                        type="checkbox"
                        onChange={() =>
                          handleCheckboxChange("Bathroom", "20 m²", 2000)
                        }
                      />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="checkbox"
                        onChange={() =>
                          handleCheckboxChange("Kitchen", "20 m²", 2000)
                        }
                      />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="checkbox"
                        onChange={() =>
                          handleCheckboxChange("Storage", "38 m²", 2000)
                        }
                      />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input
                        type="checkbox"
                        onChange={() =>
                          handleCheckboxChange("Garden", "38 m²", 2000)
                        }
                      />
                    </td>
                  </tr>
          ...
          <div className="cost-of-building-notes">
            <p>
              *living room: if you increase the size of the bedroom it will
              automatically become larger place with a possibility of a living
              room maybe
            </p>
            <p>
              *kitchen: if you increase the size of your kitchen to upgrade it
              into a living area
            </p>
      ...
      <div className="construction-overview-section">
        <div className="construction-overview-content">
          <div className="construction-overview-left">
            <h2 className="construction-overview-heading">
            ...
            <p className="construction-overview-description">
              ...
              options to make sure it looks amazing. We have given you the
              option to do slight customization. The full project will be
              completed within 4 months. There will be a garden, and you have
              the possibility to increase land size. The contract is based on a
              22-year lease and an Airbnb revenue model for you to use and get
              extra side income from, of which we will be part and set
            ...
            <p className="construction-overview-description3">
              Start your <span className="highlight-red">Passive!</span> income
              now
            </p>
          </div>
      ...
      <div className="photo-gallery-section">
        ...
        <div className="photo-gallery-images">
          <img
            src={require("../assets/images/package1gallery1.png")}
            alt="Gallery Image 1"
            className="photo-gallery-image"
          />
          <img
            src={require("../assets/images/package1gallery2.png")}
            alt="Gallery Image 2"
            className="photo-gallery-image"
          />
          <img
            src={require("../assets/images/package1gallery3.png")}
            alt="Gallery Image 3"
            className="photo-gallery-image"
          />
        </div>
